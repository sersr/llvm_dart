...
//       if (parser.globalImportStmt.isNotEmpty) {
//         print(parser.globalImportStmt.values.join('\n'));
//       }
...
//       for (var val in parser.globalImportStmt.values) {
//         val.analysis(alc);
//       }
//       for (var val in parser.globalStmt.values) {
//         val.analysis(alc);
//       }
...
//     if (currentPath != null) {
//       pathName = currentDir.childFile(currentPath).parent.childFile(pname).path;
//     } else {
...
//         for (var val in mImport.globalImportStmt.values) {
//           val.build(child);
//         }
